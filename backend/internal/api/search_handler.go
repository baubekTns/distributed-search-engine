...
func NewSearchHandler(searchClient *indexer.Client) *SearchHandler {
...
func (h *SearchHandler) search(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, http.StatusBadRequest, "crawled_after must use YYYY-MM-DD")
		return
	}
	before, err := parseDateParameter(r, "crawled_before")
	if err != nil {
		writeError(w, http.StatusBadRequest, "crawled_before must use YYYY-MM-DD")
		return
	}
